...
function handle_input(arg1, arg2) {
...
main_canvas.addEventListener('mousemove', function (e) {
    ...
    if (typeof mouse_move != "undefined")
        mouse_move(mouse_pos.x, mouse_pos.y);
    if (typeof handle_input != "undefined")
        handle_input("mousemove");
}, false);
main_canvas.addEventListener('mousedown', function (e) {
    ...
    if (typeof mouse_down != "undefined")
        mouse_down(mouse_pos.x, mouse_pos.y);
    if (typeof handle_input != "undefined")
        handle_input("mousedown", [mouse_pos.x, mouse_pos.y]);
}, false);
main_canvas.addEventListener('mouseup', function (e) {
    mouse_is_down = false;
    mouse = get_mouse_pos(main_canvas, e);
    var mouse_pos = get_mouse_pos(main_canvas, e);
    if (typeof mouse_up != "undefined")
        mouse_up(mouse_pos.x, mouse_pos.y);
    if (typeof handle_input != "undefined")
        handle_input("mouseup", [mouse_pos.x, mouse_pos.y]);
}, false);
window.addEventListener('mousewheel', function (event) {
    var e = event;
    var direction = Math.sign(e.deltaY);
    if (typeof mouse_scroll != "undefined")
        mouse_scroll(direction);
    if (typeof handle_input != "undefined")
        handle_input("mousewheel", direction);
    return;
}, false);
